...
public class ToastUtil {
    ...
    public static Toast showToast(int resId) {
        Toast toast = Toast.makeText(MyApplication.getAppContext(), MyApplication.getAppContext().getString(resId), Toast.LENGTH_SHORT);
        toast.show();
        return toast;
    }
    ...
    public static Toast showToastLong(int resId) {
        Toast toast = Toast.makeText(MyApplication.getAppContext(), resId, Toast.LENGTH_LONG);
        toast.show();
        return toast;
    }
    ...
    public static Toast showToastCenter(Context context, String info, long time) {
        final Toast toast = Toast.makeText(MyApplication.getAppContext(), info, Toast.LENGTH_LONG);
