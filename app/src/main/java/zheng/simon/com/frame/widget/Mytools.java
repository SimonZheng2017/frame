...
import zheng.simon.com.frame.widget.SPUtil;
...
public class Mytools {
    ...
    public int getNetType() {
        ConnectivityManager connectMgr = (ConnectivityManager) MyApplication.getInstance().getSystemService(Context.CONNECTIVITY_SERVICE);
