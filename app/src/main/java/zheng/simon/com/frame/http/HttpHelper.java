...
import zheng.simon.com.frame.app.Constants;
...
public class HttpHelper {
    ...
    public static void get(Context ctx, String url, ApiParams params, ApiCallBack callBack) {
        ...
        if (!Mytools.isNetworkAvailable(ctx)) {
            ...
            HttpUtil.get(Constants.SERVER + url + params.getParams(!url.endsWith("&") && !url.endsWith("?")), new MyHttpCallBack(ctx, callBack));
        }
    }
    ...
    public static void post(Context ctx, String url, ApiParams params, ApiCallBack callBack) {
        ...
        if (!Mytools.isNetworkAvailable(ctx)) {
            ...
            HttpUtil.post(Constants.SERVER + url, params.getPostParams(), new MyHttpCallBack(ctx, callBack));
        }
    }
    ...
    public static void postFile(Context ctx, String url, ApiParams params, ApiCallBack callBack) {
        ...
        if (!Mytools.isNetworkAvailable(ctx)) {
            ...
            if (params == null)
                params = new ApiParams();
            HttpUtil.postFile(Constants.SERVER + url, params.getFileUploadParams(), new MyHttpCallBack(ctx, callBack));
        }
    }
